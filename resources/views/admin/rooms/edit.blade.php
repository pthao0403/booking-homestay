...
<div class="admin-container">
    ...
    <div class="admin-content">
        ...
        <form action="{{ route('admin.rooms.update', $room) }}" method="POST" class="form" enctype="multipart/form-data">
            ...
            <input type="hidden" id="latitude" name="latitude" value="{{ old('latitude', $room->latitude) }}">
            <input type="hidden" id="longitude" name="longitude" value="{{ old('longitude', $room->longitude) }}">
